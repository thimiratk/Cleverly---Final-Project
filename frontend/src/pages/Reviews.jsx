      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {user ? (
          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-8 rounded-xl mb-12 text-center shadow-sm">
            ...
            <p className="text-blue-600 mb-4">Login to share your product experiences with others</p>
            <a href="/login" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition duration-150">
        ...
        <div className="grid gap-8">
          {reviews.length > 0 ? (
            ...
            <div className="text-center py-16 bg-white rounded-xl shadow-sm border border-gray-100">
              <div className="mb-4">
                <svg className="w-16 h-16 mx-auto text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 48 48">
